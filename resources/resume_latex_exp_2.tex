...
\begin{itemize}
	\item\vspace{-6pt} \textbf{B.S. Computer Science, Cumulative GPA: 3.88}
	\item\vspace{-6pt}\textbf{Coursework:} Intermediate Python, Data Structure (C++)
...
\textbf{Los Angeles Housing Department} \hfill September 2021 -  Present\\
Software Application Support Intern
\begin{itemize}
	\item\vspace{-6pt} Helped resolve issues in the intranet, utilizing Azure DevOps
	\item\vspace{-6pt} Retrieved and updated information from the internal database using SQL
	\item\vspace{-6pt} Created a screen scraper with Selenium to automate testing of the customer billing portal
\end{itemize}
\vspace{-6pt}
...
\textbf{Familiar with:} Java, Javascript, Git \\\vspace{-6pt}\\
